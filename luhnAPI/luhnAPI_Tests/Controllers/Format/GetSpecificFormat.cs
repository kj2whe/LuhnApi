...
namespace LuhnAlgorithim.Controllers.Tests
{
    ...
    public class GetSpecificFormat
    {
        ...
        [TestMethod()]
        public void GetSpecificFormat_FormatTypeIsFoundInList_True()
        {
            string formatType = "v";

            var expected = JsonConvert.SerializeObject(_formatTypes.SingleOrDefault(x => x.abbr.Equals(formatType, StringComparison.CurrentCultureIgnoreCase)));

            var actual = _formatController.GetSpecificFormat(formatType);

            Assert.AreEqual(expected, actual);
        }

        [TestMethod()]
        public void GetSpecificFormat_FormatTypeIsNotFoundInList_ErrorMessageReturned()
        {
            string formatType = "q";

            var expected = "You must specify an appropriate formatType";
        ...
        [TestMethod()]
        public void GetSpecificFormat_FormatTypeIsProvided_ErrorMessageReturned()
        {
